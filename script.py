...
black_button = gpiozero.Button(8, pull_up=True, hold_time=0.3, bounce_time=0.5)
yellow_button = gpiozero.Button(1, pull_up=True, hold_time=0.3, bounce_time=0.5)
red_button = gpiozero.Button(7, pull_up=True, hold_time=0.3, bounce_time=0.5)
key_button = gpiozero.Button(25, pull_up=True, hold_time=0.3, bounce_time=0.5, hold_repeat=True)
