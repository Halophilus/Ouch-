...
black_button = Button(8, pull_up=True, hold_time=0.3, hold_repeat=True)
yellow_button = Button(1, pull_up=True, hold_time=0.3, hold_repeat=True)
red_button = Button(7, pull_up=True, hold_time=0.3, hold_repeat=True)
key_button = Button(25, pull_up=True, hold_time=0.3, hold_repeat=True)
